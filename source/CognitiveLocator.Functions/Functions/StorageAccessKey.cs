...
namespace CognitiveLocator.Functions
{
    ...
    {
        [FunctionName(nameof(StorageAccessKey))]
            ...
            [HttpTrigger(AuthorizationLevel.Function, "post", Route = "StorageAccessKey/")]HttpRequestMessage req, TraceWriter log)
        {
            ...
            var decrypted_token = CryptoManager.Decrypt(accessStorageToken.Token, Settings.CryptographyKey);
            ...
            return req.CreateResponse(HttpStatusCode.OK, Settings.AzureWebJobsStorage);
        }
    }
}
